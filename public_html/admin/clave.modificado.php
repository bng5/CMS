  ...
  if(!empty($mensaje_de_error))
   {
    echo "
		 <tr>
		  <td colspan=\"2\" id=\"login_error\">".$mensaje_de_error."</td>
         </tr>";
   }
...
?>
		 <tr class="campos">
		  ...
		  <td class="campos2"><input type="password" name="clave" id="clave" onblur="this.className='campo'" onfocus="this.className='campo_on'" tabindex="1" class="campo" /></td>
         </tr>
		 <tr class="campos">
		  <td class="campos1"><label for="clave2">Repita su contrase&ntilde;a</label></td>
		  <td class="campos2"><input type="password" name="clave2" id="clave2" onblur="this.className='campo'" onfocus="this.className='campo_on'" tabindex="2" class="campo" /></td>
         </tr>
		 <tr>
		  <td colspan="2" style="padding-left:17px;padding-right:14px;">
			  ...
			  <td align="right"><input type="submit" value="Recuperar" class="boton" /></td>
             </tr>
			 </table>
		  </td>
         </tr>
